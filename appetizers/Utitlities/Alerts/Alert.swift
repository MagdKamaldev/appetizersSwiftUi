...
struct AlertContext{
    ...
    static let userSaveSucess =  AlertItem(title: Text("Profile Saved"), message: Text("your profile information has been successfully saved !"), dissmissButton: .default(Text("OK")))
